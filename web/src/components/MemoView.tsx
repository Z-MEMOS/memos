...
const MemoView: React.FC<Props> = (props: Props) => {
  ...
  return (
    <div
      className={clsx(
        "memo group relative flex flex-col justify-start items-start w-full px-4 py-3 mb-2 gap-2 bg-white dark:bg-zinc-800 rounded-lg border border-white dark:border-zinc-800 hover:border-gray-200 dark:hover:border-zinc-700",
